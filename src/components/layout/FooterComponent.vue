    ...
    <div class='wrapper'>
      ...
      <div class="about">
        <div class="logo-area">
          ...
          <div class="copyright">
            Создано с помощью 
            <a href="https://barklim.github.io/" title="Trade MC - автодонат на ваш игровой сервер">Barky </a>
            © 2020
          </div>
        </div>
        <div class="social">
          <a rel="nofollow" class="vk" href="https://vk.com/creeper.land"><i class="fa fa-vk"></i>
            <font-awesome-icon :icon="['fab', 'vk']" />
          </a>
          <a rel="nofollow" class="discord" href="https://discord.gg/55VpefK"><i class="discord icon"></i>
      ...
      <div class="content">
        <div class="links">
          <div class="title">Ссылки</div>
            <ul>
              <li><a href="/votes" target="_self">Ссылки на мониторинги</a></li>
            </ul>
          </div>
          <div class="widget-vk">
...
body.green-links .card:hover .name, body.green-links .colored, body.green-links .link, body.green-links a {
    color: #21ba45;
}
body .link, body a {
    text-decoration: none;
