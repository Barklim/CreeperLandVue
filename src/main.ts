...
import { faTags, faTag, faShoppingBasket, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
...
library.add(faTags, faTag, faShoppingBasket, faTrashAlt, faFontAwesome, faVk, faDiscord);
